...
public class ModeloUsuarioPrincipal {
    int usuariop_id;
    String Nombre, Apellido, Usuario, Password, Telefono, Direccion, Comuna;
    int rol_id;

    public ModeloUsuarioPrincipal() {
    }

    public ModeloUsuarioPrincipal(int usuariop_id, String nombre, String apellido, String usuario, String password, String telefono, String direccion, String comuna, int rol_id) {
