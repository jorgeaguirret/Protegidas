...
public class daoUsuarioPrincipal {
    ...
    ArrayList<ModeloUsuarioPrincipal> lista;
    SQLiteDatabase sql;
    ...
    public daoUsuarioPrincipal(Context c){
        ...
        sql.execSQL(tabla);
        u=new ModeloUsuarioPrincipal();
    }


    public boolean insertUsuario(ModeloUsuarioPrincipal u){
    ...
    public int buscar(String u){
        int x=0;
        lista=selectUsuario();
        for (ModeloUsuarioPrincipal us:lista) {
    ...
    public ArrayList<ModeloUsuarioPrincipal> selectUsuario(){
        ArrayList<ModeloUsuarioPrincipal> lista=new ArrayList<ModeloUsuarioPrincipal>();
        lista.clear();
        Cursor cr=sql.rawQuery("select * from usuarioprincipal", null);
        if (cr!=null&&cr.moveToFirst()){
            do {
                ModeloUsuarioPrincipal u=new ModeloUsuarioPrincipal();
    ...
    public ModeloUsuarioPrincipal getUsuario(String u, String p){
        lista=selectUsuario();
        for (ModeloUsuarioPrincipal us: lista) {
    ...
    public ModeloUsuarioPrincipal getUsuarioById(int usuariop_id){
        lista=selectUsuario();
        for (ModeloUsuarioPrincipal us: lista) {
    ...
    public boolean updateUsuario(ModeloUsuarioPrincipal u){
        ContentValues cv=new ContentValues();
